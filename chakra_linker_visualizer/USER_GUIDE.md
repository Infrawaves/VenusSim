...
$ python3 -m venv chakra_lv_env

# Activate the virtual environment
$ source chakra_lv_env/bin/activate
```
...
### Step 3: Install et_replay
Installing et_replay is necessary for Chakra to function properly as it imports essential components from it.

```bash
$ cd path/to/chakra_linker_visualizer
$ cd extern/et_replay
$ pip install .
```
...
### (Do not use) Execution Trace Converter (chakra_converter)
