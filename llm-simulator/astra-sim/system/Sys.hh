...
class Sys : public Callable {
 ...
 public:
  ...
  LogicalTopology* get_logical_sub_topology(ComType comm_type);
  ...
  std::map<std::string, GeneralComplexSubTopology*> logical_sub_topologies;
  ...
  // log-level control
  AstraLogLevel log_level;
  
  // trace definition
  bool simplifed_trace;
  bool template_trace;
